...
{{-- Main Header Container with Banner Background --}}
<div class="position-relative w-100"
    ...
    <x-clickable-card :link="'/posts/' . $post->id">
        <div class="card-header bg-white bg-opacity-75 d-flex justify-content-between align-items-center py-3 border-bottom-0 position-relative">
